        ...
        {postingLoading ? (
          ...
          <div className="flex justify-between">
            ...
            <div className="flex">
              ...
              posting?.timeslots[0]?.student_status.saved === "true" ? (
                <div
                  onClick={() => updateSave(posting?.id, false)}
                  className="hover:shadow-md cursor-pointer flex justify-center self-center items-center rounded-full h-10 w-10 hover:bg-gray-200"
                >
                  <i className="fa-lg fa-solid fa-bookmark" />
                </div>
              ) : (
                <div
                  onClick={() => updateSave(posting?.id, true)}
                  className="hover:shadow-md flex cursor-pointer justify-center self-center items-center rounded-full h-10 w-10 hover:bg-gray-200"
                >
                  <i className="fa-lg fa-regular fa-bookmark" />
                </div>
              )}
            </div>
          </div>
